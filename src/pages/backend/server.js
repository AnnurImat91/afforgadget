...
// Middleware untuk menerima JSON dari request body
app.use(cors()); // Mengizinkan akses dari frontend
app.use(express.json()); // Parsing JSON di request body

// ===== Koneksi MongoDB =====
const mongoUri = process.env.MONGO_URL || "mongodb://localhost:27017/test";  // Ganti jika menggunakan MongoDB lokal
