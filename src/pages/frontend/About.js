...
const About = () => {
  ...
  const animatedRef = useRef(false); // agar tidak ter-trigger berkali-kali
      ...
      <section className="about-section">
        <div className="container">
          ...
          <p className="right-text">
            We believe in the potential oyf entrepreneurs to lead with integrity, scale their businesses exponentially, and create jobs and prosperity for all.
          </p>
        </div>
